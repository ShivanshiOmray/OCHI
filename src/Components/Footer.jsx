...
const Footer = () => {
  return (
    <div className="w-full h-screen flex gap-2">
      <div className="w-1/2 h-full px-14 py-10 flex flex-col justify-between">
        <div className="heading">
          <h1 className="text-[7vw] tracking-tighter font-bold uppercase leading-none -mb-5">
            Eye-
          </h1>
          <h1 className="text-[7vw] tracking-tighter font-bold uppercase leading-none -mb-5">
            Opening
      ...
      <div className="relative w-1/2 h-full px-14 py-10">
        <h1 className="text-[6vw] tracking-tighter font-bold uppercase leading-none -mb-5">
          presentations
        </h1>
        <div className="dets mt-16">
          <a className="block text-[1.2vw] font-regular mb-6" href="#">
            S:
          </a>
          <a className="block text-[1.1vw] font-regular underline" href="#">
            Instagram
          </a>
          <a className="block text-[1.1vw] font-regular underline" href="#">
            Behance
        ...
        <div className="dets mt-10">
          <a className="block text-[1.2vw] font-regular mb-4" href="#">
            E:
          </a>
          <a className="block text-[1.1vw] font-regular underline" href="#">
            hello@ochi.design
        ...
        <div className="absolute top-[24vw] right-[5vw] dets">
          <a className="block text-[1.2vw] font-regular mb-6" href="#">
            M:
          </a>
          <a className="block text-[1.1vw] font-regular underline" href="#">
